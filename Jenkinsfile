pipeline {
    ...
    parameters {
        ...
        string(name: 'BACKEND_CONFIG', defaultValue: 'remote.hcl', description: 'Specify backend config file for Terraform initialization (e.g., remote-staging.hcl or gcs-staging.hcl)')
